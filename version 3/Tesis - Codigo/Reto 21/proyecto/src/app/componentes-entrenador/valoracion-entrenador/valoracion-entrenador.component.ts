...
@Component({
  selector: 'app-valoracion-entrenador',
  templateUrl: './valoracion-entrenador.component.html',
  styleUrls: ['./valoracion-entrenador.component.css']
})
export class ValoracionEntrenadorComponent implements OnInit {
