                ...
                Swal.fire({
                  ...
                  if(estado == 1){
                    ...
                    this.auth.searchEmailUser(form3).subscribe(res => {
                      ...
                      let form5 = {correo};
                      this.email.sendEmailUpdateStateActived(form5).subscribe(res => {
                        
                        if(res == 'Correo enviado'){
                
                          Swal.fire({
                            icon: 'success',
                            text: 'Se le notifico al usuario por correo electronico la activación de su cuenta.'
                          }).then(response => {
                
                            const documento_usu = form.documento;
                            const id_noti_us:any = 45;
                    ...
                    this.auth.searchEmailUser(form3).subscribe(res => {
                      ...
                      let form5 = {correo};
                      this.email.sendEmailUpdateStateBlocked(form5).subscribe(res => {
                        
                        if(res == 'Correo enviado'){
                
                          Swal.fire({
                            icon: 'success',
                            text: 'Se le notifico al usuario por correo electronico el bloqueo de su cuenta.'
                          }).then(response => {
                
                            const documento_usu = form.documento;
                            const id_noti_us:any = 46;
                            let form5 = {id_noti_us,documento_usu};
                            this.notification.sendOneNotification(form5);
      ...
      this.auth.updatePlanUserm(form).subscribe(res => {
        ...
        if(res == 'Plan actualizado con exito'){
          ...
          Swal.fire({
            ...
            const documento = form.documento_usuarios_pago;
            let form3 = {documento};
            let correo:any = '';
            this.auth.searchEmailUser(form3).subscribe(res => {
              ...
              let form5 = {correo};
              this.email.sendEmailUpdatePlans(form5).subscribe(res => {
                
                if(res == 'Correo enviado'){
        
                  Swal.fire({
                    icon: 'success',
                    text: 'Se le notifico al usuario por correo electronico la actualización de us plan contratado.'
                  }).then(response => {
        
                    const documento_usu = form.documento;
                    const id_noti_us:any = 41;
                    let form5 = {id_noti_us,documento_usu};
                    this.notification.sendOneNotification(form5);
        ...
        this.auth.updateTypeAssessmentUser(form).subscribe(res => {
          ...
          if(res == 'Tipo de valoracion actualizada'){
            ...
            Swal.fire({
              ...
              const documento = this.documento_usuario;
              let form3 = {documento};
              let correo:any = '';
              this.auth.searchEmailUser(form3).subscribe(res => {
                ...
                let form5 = {correo};
                this.email.sendEmailUpdateTypeAssessment(form5).subscribe(res => {
                  
                  if(res == 'Correo enviado'){
          
                    Swal.fire({
                      icon: 'success',
                      text: 'Se le notifico al usuario por correo electronico la actualización del tipo de valoración.'
                    }).then(response => {
          
                      const documento_usu = form.documento;
                      const id_noti_us:any = 42;
                      let form5 = {id_noti_us,documento_usu};
                      this.notification.sendOneNotification(form5);
                ...
                if(res == 'Perfil actualizado con exito'){
                  ...
                  Swal.fire({
                    ...
                    this.auth.searchEmailUser(form3).subscribe(res => {
                      ...
                      let form5 = {correo};
                      this.email.sendEmailUpdateInfoUser(form5).subscribe(res => {
                        
                        if(res == 'Correo enviado'){
                
                          Swal.fire({
                            icon: 'success',
                            text: 'Se le notifico al usuario por correo electronico la actualización de la información del perfil.'
                          }).then(response => {
                
                            const documento_usu = form.documento;
                            const id_noti_us:any = 43;
                            let form5 = {id_noti_us,documento_usu};
                            this.notification.sendOneNotification(form5);
          ...
          if(res == 'Pago actualizado con éxito'){
            ...
            Swal.fire({
              ...
              this.auth.searchEmailUser(form3).subscribe(res => {
                ...
                let form5 = {correo};
                this.email.sendEmailUpdateTimePago(form5).subscribe(res => {
