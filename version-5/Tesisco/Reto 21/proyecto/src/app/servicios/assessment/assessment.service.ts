...
export class AssessmentService {
  ...
  searchAssessmentBasic(form:any){
   ...
   searchEmailUserAdvanced(form:any){
    return this.http.post(`${this.URL}/assessment/searchEmailUserAdvanced`,form);
   }

   searchEmailUserBasic(form:any){
    return this.http.post(`${this.URL}/assessment/searchEmailUserBasic`,form);
   }
