...
@Component({
  selector: 'app-record-routine-personal',
  templateUrl: './record-routine-personal.component.html',
  styleUrls: ['./record-routine-personal.component.css']
})
export class RecordRoutinePersonalComponent implements OnInit {
  ...
  drop(event: CdkDragDrop<string[]>) {
    if (event.previousContainer === event.container) {
      ...
      if(anterior == 'cdk-drop-list-1'){
        ...
        let form1 = {};
        form1= {id_ejercicio,id_plan_entrenamiento};
        console.log(form1);
        this.routinesService.deleteTrainingToPlan(form1).subscribe(res => {
              ...
              if(res == 'Registro completado'){
                ...
                Swal.fire({
                  ...
                  if(role == 'cli_i-dfg078op1_0i1/'){
                    ...
                    this.router.navigateByUrl('routines-personal');
  ...
  cancellRoutine(){
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.routinesService.cancelRoutinePlanPersonal(form).subscribe(res => {

          if(res == 'proceso cancelado'){
