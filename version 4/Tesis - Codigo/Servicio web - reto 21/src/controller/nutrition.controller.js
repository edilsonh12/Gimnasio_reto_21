...
const selectNewUsers = async (req, res) => {
    ...
    try {
        const response = await pool.query('select documento,id_plan_nutri_nutri,nombre_tipo_nutri, nombres, primer_apellido, segundo_apellido from usuarios, tipo_nutricional, tipo_usuario_nutri,rol where id_plan_nutri_nutri=id_plan_nutri and documento_nutri_nutri=documento and rol=id_rol and rol=5 except  select documento,id_plan_nutri_nutri,nombre_tipo_nutri, nombres, primer_apellido, segundo_apellido from usuarios,plan_nutricional, tipo_usuario_nutri, plan_nutricional_usuarios, tipo_nutricional, rol where plan_nutricional_usuarios.id_plan_nutri=id_plan and documento_plan=documento and tipo= tipo_nutricional.id_plan_nutri and rol=id_rol and rol=5');
...
const selectOldUsers = async (req, res) => {
    ...
    try {
        const response = await pool.query('select id_plan,documento,plan_nutricional_usuarios.id_plan_nutri,nombre_tipo_nutri, nombres, primer_apellido, segundo_apellido from usuarios,plan_nutricional, plan_nutricional_usuarios, tipo_nutricional, rol where plan_nutricional_usuarios.id_plan_nutri=id_plan and documento_plan=documento and tipo= tipo_nutricional.id_plan_nutri and rol = id_rol and rol = 5');
...
const selectNutritionGeneral = async (req, res) => {
    ...
    try {
        const response = await pool.query('select id_plan, nombre_plan, nombre_tipo_nutri from plan_nutricional, tipo_nutricional where tipo=id_plan_nutri and id_plan_nutri=1');        
